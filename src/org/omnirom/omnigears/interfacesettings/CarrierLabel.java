...
public class CarrierLabel extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCarrierColorPicker.setColor(intColor);

        if (TelephonyManager.getDefault().isMultiSimEnabled()) {
            // TODO msim must be handled different
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mCarrierColorPicker) {
            int color = mCarrierColorPicker.getColor();
            Settings.System.putInt(getActivity().getApplicationContext().getContentResolver(),
                    Settings.System.STATUS_BAR_CARRIER_COLOR, color);
            return true;
            ...
            Settings.System.putInt(resolver, Settings.System.STATUS_BAR_SHOW_CARRIER, showCarrierLabel);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        if (preference.getKey().equals(CUSTOM_CARRIER_LABEL)) {
            ...
            final View view = inflater.inflate(R.layout.dialog_carrier_label, null);
            alert.setView(view);
            alert.setTitle(R.string.custom_carrier_label_title);
            alert.setMessage(R.string.custom_carrier_label_explain);

            final EditText input = (EditText) view.findViewById(R.id.carrier_label_edit_text);
